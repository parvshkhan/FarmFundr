//
//  ApiEventDetailsByParticularId.swift
//  FarmFundr
//
...
struct ApiGetEventListById {
    ...
    init(response : NSDictionary) {
        if let someEventList = response["payload"] as? NSDictionary{
          eventDetail = EventDetails(dictionary: someEventList)
        }
    }
}
